  ...
  if (_bad == false) {
      ...
      if (mode == modes.circle) {
        ...
        if (conditionMet == null) {
          ...
          ___tableList.push([_mouseX, _mouseY, structuredClone(___tableList.length + 2), mode + _amount, cordX, cordY, _cell4, mode, [radius], [], "_CGcirlceElement_" + _amount]);
        }
      } else if (mode == modes.dot) {
        ...
        ___tableList.push([_mouseX, _mouseY, structuredClone(___tableList.length + 2), mode + _amount, cordX, cordY, _cell4, mode, null, null]);
      }
  } else {
