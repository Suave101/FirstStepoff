...
function setMousePosition(e) {
  ...
  if (cordY > 57) {
    ...
    cordY = ((cordY - 57)*-1) + " in behind of front hash"
  }
...
function draw() {
    ...
    drawNumbers(60, 154, 10);drawNumbers(90, 154, 20);drawNumbers(120, 154, 30);drawNumbers(150, 154, 40);drawNumbers(180, 154, 50);drawNumbers(210, 154, 40);drawNumbers(240, 154, 30);drawNumbers(270, 154, 20);drawNumbers(300, 154, 10);
    context.stroke();
    context.beginPath();
